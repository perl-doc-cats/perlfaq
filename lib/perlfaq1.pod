...
The current leading implementation of Perl 6, Rakudo Star, released a
"useful, usable, 'early adopter'" distribution of Perl 6 in July of
...
In short, Perl 4 is the past, Perl 5 is the present, and Perl 6 is a
sibling of Perl 5, incompatible but related and relevant.
...
family. Contrary to popular belief, Perl 6 does not intend to replace or
outdate Perl 5--most developers writing Perl 5 have no intentions of
switching to Perl 6. That said, Perl 6 has proven to be a fascinating
research project for those doing Perl 5 development, and the source of
many ideas now seeing widespread production use (the Moose object system
is a well-known example). The current leading implementation of Perl 6
is Rakudo Star, and you can learn more about it at http://rakudo.org.
...
As Perl 6 is a reinvention of Perl 5, it is a language in the same
lineage but not compatible. Neither one is mutually exclusive with the
other, and neither one precludes the other. Perl 6 is not meant to
replace Perl 5, and vice versa.
