...
distribution for more details. See L<perlhist> for Perl's milestone 
releases.
...
and L<http://archive.develooper.com/perl5-porters@perl.org/>
or the news gateway nntp://nntp.perl.org/perl.perl5.porters or
its web interface at L<http://nntp.perl.org/group/perl.perl5.porters> ,
or read the faq at L<http://dev.perl.org/perl5/docs/p5p-faq.html> ,
...
Rakudo, and you can learn more about it at L<http://rakudo.org>.
...
page at L<http://dev.perl.org/perl6/> and get involved.
...
Some comparison documents can be found at L<http://www.perl.com/doc/FMTEYEWTK/versus/>
