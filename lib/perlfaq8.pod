...
Know" collection in L<https://www.cpan.org/misc/olddoc/FMTEYEWTK.tgz> . To
...
(available from CPAN).
L<https://www.cpan.org/scripts/netstuff/telnet.emul.shar> will also help
...
available drivers on CPAN: L<https://www.cpan.org/modules/by-module/DBD/> .
You can read more about DBI on L<https://dbi.perl.org/> .
