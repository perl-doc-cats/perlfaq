...
Fairly young and designed by the same author as L<Catalyst>, it focuses on HTML5
and real-time web technologies such as WebSockets. A strong emphasis on
innovation and user-friendliness without compromises can make it harder to reuse
existing experience.
