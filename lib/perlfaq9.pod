...
a large community and addon ecosystem. Can be hard to learn and dependency on
Moose makes it unsuited for CGI-mode deployment.
...
Still experimental, strongly object-oriented and intended as a toolkit for
...
OO library Moo and is also suitable for CGI deployment. API still in flux.
...
of the site you are trying to build. Review the frameworks listed
above and see which suits your needs best. Many of them share the
