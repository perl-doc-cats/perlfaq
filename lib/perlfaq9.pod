...
to look at using something like L<Template Toolkit|https://metacpan.org/pod/Template>
...
content back to you as a string:
    ...
    my $ua = HTTP::Tiny->new;
    my $html = $ua->get( "https://www.example.com/index.html" )->{content};

It can also store the resource directly in a file:

    $ua->mirror( "https://www.example.com/index.html", "foo.html" );
