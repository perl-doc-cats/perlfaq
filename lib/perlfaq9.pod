...
perlfaq9 - Networking, Web and Email
...
The best way it to use L<HTML::Parser>from CPAN. You could also use
L<HTML::FormatText> which not only removes HTML but also attempts to do a 
...
L<LWP> to submit to your website. If you want to prevent data that
