...
L<https://www.cpan.org/misc/olddoc/FMTEYEWTK.tgz>
...
L<https://drdobbs.com/creating-a-perl-debugger/184404522> , and "Profiling in Perl"
L<https://drdobbs.com/profiling-in-perl/184404580> .
...
L<https://www.perl.com/pub/2006/02/09/debug_mod_perl.html/> .

Randal L. Schwartz writes about profiling in "Speeding up Your Perl
Programs" for I<Unix Review>,
L<https://www.stonehenge.com/merlyn/UnixReview/col49.html> , and "Profiling
in Template Toolkit via Overriding" for I<Linux Magazine>,
L<https://www.stonehenge.com/merlyn/LinuxMag/col75.html> .
...
L<https://www.cpan.org/authors/id/T/TO/TOMC/scripts/toms.exrc.gz>
...
L<https://www.ActiveState.com/products/komodo-ide/>
...
L<https://notepad-plus-plus.org/>

=item Open Perl IDE

L<https://sourceforge.net/projects/open-perl-ide/>
...
L<https://www.solutionsoft.com/perl.htm>
...
L<https://helpconsulting.net/visiperl/index.html>

From Help Consulting, for Windows.

=item Zeus

L<https://www.zeusedit.com/index.html>
...
L<https://www.textpad.com/home> ) and UltraEdit ( L<https://www.ultraedit.com/> ),
among others.

If you are using MacOS, the same concerns apply. MacPerl (for Classic
environments) comes with a simple editor. Popular external editors are
BBEdit ( L<https://www.barebones.com/products/bbedit/> ) or Alpha (
L<https://www.his.com/~jguyer/Alpha/Alpha8.html> ). MacOS X users can use
...
L<https://www.gnu.org/software/emacs/manual/efaq-w32.html>

=item MicroEMACS

L<https://www.microemacs.de/>

=item XEmacs

L<https://www.xemacs.org/Download/index.html>

=item Jed

L<https://space.mit.edu/~davis/jed/>
...
L<https://invisible-island.net/vile/vile.html>
...
L<https://www.MultiEdit.com/>

=item SlickEdit

L<https://www.slickedit.com/>

=item ConTEXT

L<https://www.contexteditor.org/>

=back

There is also a toyedit Text widget based editor written in Perl
that is distributed with the Tk module on CPAN. The ptkdb
( L<https://ptkdb.sourceforge.net/> ) is a Perl/Tk-based debugger that
acts as a development environment of sorts. Perl Composer
( L<https://perlcomposer.sourceforge.net/> ) is an IDE for Perl/Tk
GUI creation.
...
from the Cygwin package ( L<https://cygwin.com/> )
...
see L<https://www.cpan.org/authors/id/T/TO/TOMC/scripts/toms.exrc.gz> ,
the standard benchmark file for vi emulators. The file runs best with nvi,
the current version of vi out of Berkeley, which incidentally can be built
with an embedded Perl interpreter--see L<https://www.cpan.org/src/misc/> .
...
directory L<https://www.cpan.org/authors/id/T/TO/TOMC/scripts/rep.gz> ;
...
( L<https://www.wxwidgets.org> ). It works under Unix, Win32 and Mac OS X,
...
These are Perl bindings for the Gtk toolkit ( L<https://www.gtk.org> ). The
...
CamelBones ( L<https://camelbones.sourceforge.net> ) is a Perl interface to
...
L<https://www.apache.org/> ) with either of the mod_perl or mod_fastcgi
plugin modules.
...
module (available from L<https://www.fastcgi.com/> ) each of your Perl
...
See also
L<https://www.cpan.org/modules/by-category/15_World_Wide_Web_HTML_HTTP_CGI/> .
...
The Perl Dev Kit ( L<https://www.activestate.com/products/perl/> )
from ActiveState can "Turn your Perl programs into ready-to-run
executables for HP-UX, Linux, Solaris and Windows."

Perl2Exe ( L<https://www.indigostar.com/perl2exe/> ) is a command line
...
Sanchez' DropScript utility: L<https://www.wsanchez.net/software/> .
...
guides and references in L<perlfaq9>.
