...
L<ActiveState|http://www.activestate.com/> Windows, Linux, Mac OS X, Solaris, AIX and HP-UX

L<Sunfreeware.com|http://www.sunfreeware.com/> Solaris 2.5 to Solaris 10 (SPARC and x86)

L<Strawberry Perl|http://www.strawberryperl.com> Windows, Perl 5.8.8 and 5.10.0

L<IndigoPerl|http://indigostar.com/> Windows
...
For Windows, <Vanilla Perl|http://vanillaperl.com/> and 
