...
can find the latest releases at L<http://www.cpan.org/src/README.html>.
...
See CPAN Ports: L<http://www.cpan.org/ports/>
...
For Windows, 
Strawberry Perl L<http://strawberryperl.com/> and
ActivePerl L<http://www.activestate.com/activeperl> come with a
bundled C compiler.
...
L<http://www.cpan.org/> and there is the CPAN Multiplexer at
L<http://www.cpan.org/CPAN.html> which will choose a mirror near you via
DNS. See L<http://www.perl.com/CPAN> (without a slash at the end) for
how this process works. Also, L<http://mirror.cpan.org/> has a nice
interface to the L<http://www.cpan.org/MIRRORED.BY> mirror directory.
...
instance, if you're using L<ftp://ftp.funet.fi/pub/languages/perl/CPAN>
as your CPAN site, the file F<CPAN/misc/japh> is downloadable as
L<ftp://ftp.funet.fi/pub/languages/perl/CPAN/misc/japh>.
...
See L<http://www.cpan.org/modules/00modlist.long.html> or
L<http://search.cpan.org/> for a more complete list of modules by
category.
...
If all else fails, consult L<http://perldoc.perl.org/> which has the
...
at L<http://nntp.perl.org/group/> and these lists are also available
under the C<perl.*> hierarchy at L<http://groups.google.com>. Other
groups are listed at L<http://lists.perl.org/> ( also known as
L<http://lists.cpan.org/> ).

A nice place to ask questions is the PerlMonks site,
L<http://www.perlmonks.org/> , or the Perl Beginners mailing list
L<http://lists.perl.org/showlist.cgi?name=beginners>.
...
see their FAQ ( L<http://www.faqs.org/faqs/alt-sources-intro/> ) for details.

If you're just looking for software, first use Google
( L<http://www.google.com> ), Google's Usenet search interface
( L<http://groups.google.com> ), and CPAN Search ( L<http://search.cpan.org> ).
...
I<Unix Review> ( L<http://www.unixreview.com/> ), I<Linux Magazine> (
L<http://www.linuxmagazine.com/> ), and Usenix's newsletter/magazine to
its members, I<login:> ( L<http://www.usenix.org/> ).

The Perl columns of Randal L. Schwartz are available on the web at
L<http://www.stonehenge.com/merlyn/WebTechniques/> ,
L<http://www.stonehenge.com/merlyn/UnixReview/> , and
L<http://www.stonehenge.com/merlyn/LinuxMag/>.
...
L<http://www.ddj.com/> or brian d foy's index of online TPJ content
( L<http://www.perlmonks.org/index.pl?node_id=711609> ).
...
L<http://groups.google.com/group/comp.lang.perl.misc/topics>
...
L<http://www.perl.com/> used to be part of the O'Reilly
...
Perl Mongers website L<http://www.pm.org/> for more information about
